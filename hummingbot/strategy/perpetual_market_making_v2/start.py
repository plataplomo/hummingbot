...
from hummingbot.strategy.perpetual_market_making_v2 import PerpetualMarketMakingStrategyV2
from hummingbot.strategy.perpetual_market_making_v2.perpetual_market_making_v2_config_map import (
    perpetual_market_making_v2_config_map as c_map,
)
...
def start(self):
    try:
        ...
        stop_loss_order_filled_delay = c_map.get("stop_loss_order_filled_delay").value
        ...
        strategy_logging_options = PerpetualMarketMakingStrategyV2.OPTION_LOG_ALL

        self.strategy = PerpetualMarketMakingStrategyV2()
        self.strategy.init_params(
            ...
            stop_loss_order_filled_delay=stop_loss_order_filled_delay,
