...
# Base tier fees for Hyperliquid Perpetuals (https://hyperliquid.gitbook.io/hyperliquid-docs/trading/fees)
...
OTHER_DOMAINS_DEFAULT_FEES = {"hyperliquid_perpetual_testnet": [0.015, 0.045]}  # [maker_fee_pct, taker_fee_pct]
