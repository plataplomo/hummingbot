...
6.  **Interaction & Safety:**
    *   **Adhere to Project Rules:** Always prioritize project-specific rules defined via Cursor's features over these global defaults if there's a conflict. Reference project rules when relevant.
