...
- Multiple community forks active:
  - `gekko-plus-plus` (most active fork)
  - `gekko-strategies` (strategy collection)
...
Several smaller but active projects:
- **Superalgos** (3,500+ stars) - Visual strategy designer
- **Crypto-signal** (4,800+ stars) - Technical analysis bot
- **TradingView-webhooks-bot** (1,500+ stars) - TradingView integration
