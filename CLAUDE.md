...
## Project Context
This is a cryptocurrency trading engine (CyberDeltaEngine) that connects to Hyperliquid and Backpack exchanges for delta-neutral arbitrage strategies.

## Notes
[Session-specific notes go here]