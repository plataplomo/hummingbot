...
class EventStore(Protocol):
    ...
    async def store(self, event: BaseEvent[Any]) -> None:
        """Store an event.
...
class EventProcessor(Protocol):
    ...
    async def process(self, event: BaseEvent[Any]) -> None:
        """Process an event.
    ...
    def can_process(self, event: BaseEvent[Any]) -> bool:
...
class EventMetrics(Protocol):
    ...
    def record_event_published(self, event: BaseEvent[Any]) -> None:
