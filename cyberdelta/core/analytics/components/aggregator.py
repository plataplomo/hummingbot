...
from cyberdelta.core.infrastructure.events import BaseEvent, EventType
...
class MetricsAggregator:
    ...
    async def update_position_metrics(self, event: BaseEvent[dict[str, Any]]) -> None:
    ...
    async def update_trade_metrics(self, event: BaseEvent[dict[str, Any]]) -> None:
    ...
    async def update_balance_metrics(self, event: BaseEvent[dict[str, Any]]) -> None:
    ...
    async def _update_trade_counters(self, event: BaseEvent[dict[str, Any]]) -> None:
