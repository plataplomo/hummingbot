...
from cyberdelta.core.validation.exceptions import ValidatorNotInitializedError


logger = get_logger(__name__)


class BaseValidator(ABC):  # BasePortfolioManager removed in refactor
    ...
    def _ensure_initialized(self) -> None:
        ...
        Raises:
            ValidatorNotInitializedError: If the screener is not initialized
        """
        if not self.is_initialized:
            raise ValidatorNotInitializedError(f"Validator '{self.name}' is not initialized")
