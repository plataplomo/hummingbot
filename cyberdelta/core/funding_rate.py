...
class ExchangeAdapter:
    ...
    async def get_historical_funding_rates(self, symbol: str, lookback_hours: int = 24) -> List[Tuple[int, float]]:
        """
...
class HyperliquidAdapter(ExchangeAdapter):
    ...
    async def initialize(self):
        ...
        try:
            ...
            meta_response = await self.api_client._request("POST", "/info", data={"type": "metaAndAssetCtxs"})
            ...
            if "data" in meta_response and "assetCtxs" in meta_response["data"]:
                ...
                for asset_ctx in asset_contexts:
                    ...
                    if historical_rates_values:
                        ...
                        variance = sum((x - mean) ** 2 for x in historical_rates_values) / len(historical_rates_values)
