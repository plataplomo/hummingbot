...
class RiskManager:
    ...
    async def analyze_opportunity(self, opportunity: ArbitrageOpportunity) -> RiskAnalysis:
        ...
        available_capital = portfolio_state.total_collateral
        ...
        constraint_context = ConstraintContext(
            total_capital=portfolio_state.total_collateral,
            available_capital=portfolio_state.free_collateral,
            reserved_capital=portfolio_state.total_collateral - portfolio_state.free_collateral,
            current_positions=[],
            current_allocations={},
    ...
    async def get_risk_metrics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "available_capital": float(portfolio_state.total_collateral),
