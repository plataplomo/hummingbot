...
class SystemHealthChecker(BaseService):
    ...
    def __init__(
        ...
        super().__init__("system_health_checker", config)
    ...
    async def _initialize_service(self) -> None:
        ...
        self.logger.info("Initializing system health checker")

    async def _shutdown_service(self) -> None:
        """Shutdown portfolio health checker."""
        self.logger.info("Shutting down system health checker")
