...
class HyperliquidRawL2UsdTransferPayload(BaseModel):
    ...
    destination: RawEthereumAddressStr = Field(..., description="The recipient's 0x address.")
    token: Annotated[
...
class HyperliquidRawWithdrawalToL1ActionPayload(BaseModel):
    ...
    destination: RawEthereumAddressStr = Field(..., description="The recipient's 0x address on L1.")
