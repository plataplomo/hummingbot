...
This is the core error context model used throughout the WebSocket system.
"""
...
class StreamErrorContext(BaseModel):
    ...
    exchange: ExchangeName = Field(description="Exchange name enum")
    ...
    @classmethod
    def validate_exchange(cls, v: ExchangeName) -> ExchangeName:
        """Validate exchange name enum contract.
