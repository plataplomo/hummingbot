...
class SimplePerformanceTracker:
    ...
    def __init__(self, strategy_name: str, output_dir: Optional[str] = None):
        """
    ...
    def track_signal_execution(self, signal_id: str, executed: bool):
        """
    ...
    def track_trade(self, trade_id: str, symbol: str, exchange: str, direction: str, 
                   ...
                   signal_id: Optional[str] = None) -> TradeMetrics:
        """
        Track a new trade.
    ...
    def update_trade_pnl(self, trade_id: str, unrealized_pnl: float):
        """
    ...
    def export_to_csv(self, filename_prefix: Optional[str] = None):
        """
...
class SimplePerformanceAnalyzer:
    ...
    def __init__(self, tracker: SimplePerformanceTracker):
        """
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        metrics = {
            ...
            'avg_profit': trades_df[trades_df['pnl'] > 0]['pnl'].mean() if not trades_df.empty and not trades_df[trades_df['pnl'] > 0].empty else 0,
            'avg_loss': trades_df[trades_df['pnl'] <= 0]['pnl'].mean() if not trades_df.empty and not trades_df[trades_df['pnl'] <= 0].empty else 0,
        }
