    ...
    def load_state(self) -> bool:
        ...
        try:
            ...
            if not self._verify_state_integrity(state_data):
                logger.warning(f"State file {self.state_file} failed integrity check, attempting to recover from backup")
            ...
            logger.error(f"Error decoding state file {self.state_file}, attempting to recover from backup")
            return self._recover_from_backup()
