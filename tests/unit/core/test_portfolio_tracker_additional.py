"""Additional comprehensive unit tests for PortfolioStateManager.
...
def portfolio_tracker(mock_app_settings: Mock, mock_pt_config: Mock) -> PortfolioStateManager:
    ...
    """
    return PortfolioStateManager(mock_app_settings, mock_pt_config)
...
class TestPortfolioTrackerReset:
    ...
    def test_reset_edge_preserves_configuration(
        self, portfolio_tracker: PortfolioStateManager, sample_ticker: Ticker
    ) -> None:
    ...
    def test_reset_edge_preserves_app_settings(
        self, portfolio_tracker: PortfolioStateManager, mock_app_settings: Mock
    ) -> None:
