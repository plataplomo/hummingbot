...
def create_mock_order(
    ...
    Returns:
        Order: Mock order instance configured with provided parameters.
    """
...
def mock_get_config(key: str, default: object | None = None) -> object | None:
    ...
    Returns:
        object | None: Mock configuration value for the given key, or default if not found.
    """
    config_values = {
...
def create_mock_order_with_details(
    ...
    Returns:
        Order: Detailed mock order instance with all specified attributes.
    """
    return Order(
        client_order_id=client_order_id,
        exchange=exchange,
