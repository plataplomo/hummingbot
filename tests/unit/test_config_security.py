  ...
  backpack:
    ...
    def test_fallback_to_home_dir(self, mock_home):
        ...
        try:
            ...
            self.assertTrue(result)
            self.assertEqual(secrets_manager.get("exchanges.hyperliquid.api_key"), "home_api_key_123")
        finally:
    ...
    def test_env_variable_override(self):
        ...
        with patch.dict('os.environ', {'CYBERDELTA_SECRETS_PATH': self.secrets_path}):
            ...
            self.assertTrue(result)
            self.assertEqual(secrets_manager.get("exchanges.hyperliquid.api_key"), "test_api_key_123")
