...
async def test_position_sizing_integration(mock_logger, strategy_with_risk_manager, setup_dependencies, mock_opportunity):
    ...
    setup_dependencies["risk_manager"].size_opportunity = MagicMock(return_value=mock_sized_opportunity)
...
def test_fallback_without_risk_manager(setup_dependencies, strategy_without_risk_manager, mock_opportunity):
