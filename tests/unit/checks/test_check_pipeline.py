...
class MockChecker(BaseCheckerInterface):
    ...
    def __init__(self, name: str, config: dict[str, Any] | None = None, should_fail: bool = False, 
                 delay_ms: int = 0, should_error: bool = False) -> None:
