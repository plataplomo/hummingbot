...
class TestAuditLogger:
    ...
    @pytest.mark.asyncio
    async def test_disabled_audit_logging(self, mock_config):
    ...
    async def test_log_order_event(self, audit_logger, sample_order):
        ...
        assert event.symbol == Symbol("BTC_USD")
    ...
    @pytest.mark.asyncio
    async def test_log_trade_event(self, audit_logger, sample_trade):
    ...
    @pytest.mark.asyncio
    async def test_log_signal_event(self, audit_logger, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_log_risk_event(self, audit_logger):
    ...
    @pytest.mark.asyncio
    async def test_log_error_event(self, audit_logger):
    ...
    @pytest.mark.asyncio
    async def test_sensitive_data_filtering(self, audit_logger):
    ...
    @pytest.mark.asyncio
    async def test_sensitive_data_not_filtered_when_enabled(self, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_buffer_flush_on_size_limit(self, audit_logger, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_start_stop_lifecycle(self, audit_logger):
        ...
        assert len(audit_logger._event_buffer) >= 1
        start_event = next(
            e for e in audit_logger._event_buffer 
    ...
    @pytest.mark.asyncio
    async def test_write_json_format(self, audit_logger):
        ...
        try:
            ...
            # Read and verify
            with open(audit_logger._audit_log_file, 'r') as f:
                lines = f.readlines()
    ...
    @pytest.mark.asyncio
    async def test_write_text_format(self, audit_logger, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_session_stats(self, audit_logger):
    ...
    @pytest.mark.asyncio
    async def test_multiple_start_calls(self, audit_logger):
