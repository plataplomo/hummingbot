...
@pytest.fixture
def performance_tracker(mock_config, mock_portfolio_service):
...
class TestPerformanceTracker:
    ...
    @pytest.mark.asyncio
    async def test_init(self, mock_config, mock_portfolio_service):
    ...
    @pytest.mark.asyncio
    async def test_add_trade(self, performance_tracker, sample_trade):
    ...
    @pytest.mark.asyncio
    async def test_update_equity_curve(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_calculate_metrics_basic(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_calculate_drawdown(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_calculate_trading_statistics(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_sharpe_ratio_calculation(self, performance_tracker):
        ...
        for i, daily_return in enumerate(daily_returns):
            ...
            await performance_tracker.update_equity_curve(
                now - timedelta(days=5-i), equity
            )
    ...
    @pytest.mark.asyncio
    async def test_disabled_metrics_not_calculated(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_get_metrics_summary(self, performance_tracker):
        """Test getting metrics summary."""
        summary = performance_tracker.get_metrics_summary()
        
        assert "enabled_metrics" in summary
        assert len(summary["enabled_metrics"]) == 6
    ...
    @pytest.mark.asyncio
    async def test_period_returns(self, performance_tracker):
    ...
    @pytest.mark.asyncio
    async def test_empty_data_handling(self, performance_tracker):
