"""Integration tests for Hyperliquid FundingRate model pipeline."""
...
@pytest.mark.parametrize(
    "custom_vcr_cassette_dir", ["apis/hyperliquid/funding_rate"], indirect=True
)
@pytest.mark.asyncio
    ...
    if len(funding_rates) > 0:
        for i, funding_rate in enumerate(funding_rates):
            ...
            assert funding_rate.symbol == "BTC", (
                ...
                f"Wrong symbol: {funding_rate.symbol}"
