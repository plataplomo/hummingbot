"""Integration tests for Hyperliquid Spot OrderBook model pipeline.
...
@pytest.mark.parametrize("custom_vcr_cassette_dir", ["apis/hyperliquid/spot/market_data/order_book"], indirect=True)
@pytest.mark.spot
@pytest.mark.asyncio
@pytest.mark.vcr
async def test_hl_spot_order_book_not_supported_placeholder(
