"""Integration tests for Hyperliquid Spot Candle model pipeline.
...
@pytest.mark.parametrize("custom_vcr_cassette_dir", ["apis/hyperliquid/spot/market_data/candle"], indirect=True)
@pytest.mark.spot
@pytest.mark.asyncio
@pytest.mark.vcr
async def test_hl_spot_candles_not_supported_placeholder(
