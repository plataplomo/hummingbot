...
@pytest.mark.parametrize("custom_vcr_cassette_dir", ["apis/hyperliquid/spot/market_data/ticker"], indirect=True)
@pytest.mark.spot
@pytest.mark.asyncio
@pytest.mark.vcr
...
async def test_hl_get_spot_ticker_performance_consistency(
    ...
    """Test HyperliquidAPI.get_ticker() performance and consistency across multiple calls for spot."""
    symbol = "BTC"
    tickers: list[Ticker] = []
