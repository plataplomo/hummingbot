"""Integration tests for Backpack Spot Market data with authentication.

These tests validate spot market data pipeline with authenticated context,
...
class TestBackpackSpotMarketPrivate:
    ...
    @pytest.mark.vcr
    @pytest.mark.asyncio
    async def test_get_spot_market_authenticated_context(
        self,
    ...
    @pytest.mark.vcr
    @pytest.mark.asyncio
    async def test_get_spot_markets_authenticated_rate_limiting(
        self,
        bp_api_for_test_env: BackpackAPI,
        custom_vcr_config: dict[str, Any],
    ) -> None:
        """Test authenticated spot market requests handle rate limiting appropriately."""
        args = GetMarketsArgs()
    ...
    @pytest.mark.vcr
    @pytest.mark.asyncio
    async def test_authenticated_spot_market_data_consistency(
        self,
        bp_api_for_test_env: BackpackAPI,
        custom_vcr_config: dict[str, Any],
    ) -> None:
    ...
    @pytest.mark.vcr
    @pytest.mark.asyncio
    async def test_authenticated_spot_market_access_permissions(
        self,
        bp_api_for_test_env: BackpackAPI,
        custom_vcr_config: dict[str, Any],
    ) -> None:
        """Test authenticated spot market access doesn't reveal restricted information."""
        args = GetMarketsArgs()
        markets = await bp_api_for_test_env.get_markets(args)
    ...
    @pytest.mark.vcr
    @pytest.mark.asyncio
    async def test_authenticated_spot_market_error_handling(
        self,
        bp_api_for_test_env: BackpackAPI,
        custom_vcr_config: dict[str, Any],
    ) -> None:
