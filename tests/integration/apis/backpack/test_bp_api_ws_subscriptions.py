...
class TestBackpackAPIWsSubscriptions:
    ...
    @pytest.mark.asyncio
    async def test_subscription_registration_public_interface(
    ...
    @pytest.mark.asyncio
    async def test_multiple_subscription_types(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_subscription_consistency(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_various_topic_formats_accepted(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_subscription_operations_consistent(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_multiple_topic_subscriptions(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_public_private_stream_handling(
        self, bp_api: BackpackAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_subscription_integration_complete(
        self, bp_api: BackpackAPI
    ) -> None:
