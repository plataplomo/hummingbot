...
@pytest.mark.parametrize(
    "custom_vcr_cassette_dir", ["apis/backpack/ticker"], indirect=True
)
@pytest.mark.asyncio
...
async def test_bp_get_ticker_eth_usdc_success(
    ...
    # Validate core ticker fields
    assert ticker.symbol == "ETH_USDC", (

        f"Expected symbol 'ETH_USDC', got '{ticker.symbol}'"
