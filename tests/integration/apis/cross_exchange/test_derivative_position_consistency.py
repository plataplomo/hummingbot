...
class TestCrossExchangeDerivativePositionConsistency:
    ...
    @pytest.mark.asyncio
    async def test_position_model_consistency(self, exchange_client: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_position_precision_handling(self, exchange_client: Any, precision: int) -> None:
