...
class TestCrossExchangeSpotBalanceConsistency:
    ...
    @pytest.mark.asyncio
    async def test_spot_balance_precision(self, exchange_client: Any, symbol: str, expected_precision: int) -> None:
    ...
    @pytest.mark.asyncio
    async def test_balance_amount_handling(self, exchange_client: Any, test_amount: Decimal) -> None:
