...
from cyberdelta.core.symbols import Symbol, symbol, exchanges, get_symbol_service
...
class SymbolTestFactory:
    ...
    def create_with_components(
        ...
        **metadata_kwargs: Any
        ...
        """
        sym = SymbolTestFactory.create_with_metadata(
            value, exchange, **metadata_kwargs
        )
