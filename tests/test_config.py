...
risk:
  global:
    ...
    def test_get_existing_value(self):
        ...
        self.assertEqual(self.config_manager.get("exchanges.hyperliquid.api_base_url"), "https://api.test.xyz")
...
database:
  password: "db_password_test"
    ...
    def test_get_existing_secret(self):
        ...
        self.assertEqual(self.secrets_manager.get("exchanges.hyperliquid.api_key"), "test_api_key_123")
